          ...
          return (
            <article key={entry.id} className="panel p-6">
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                <span className="inline-flex w-fit items-center rounded-full border border-amber-300/35 bg-amber-300/10 px-2.5 py-1 text-[0.65rem] uppercase tracking-[0.16em] text-amber-100">
                  service
                </span>
              </div>
